...
//    OUT  seven : 導水勾配線！Eown�E��Eスライス
   ...
   fmt.Println ("func kansui1 水路チE�Eタ　",wdeta )

// ラインチE�Eタを、ブランクで刁E��する

   str := strings.Fields(wdeta)

   fmt.Println ("kansui1 nummax" ,len(str))  // チE��チE��
...
//      fmt.Println("kansui1 str2" ,str2)  // チE��チE��
// 水路チE�Eタをsave

//      fmt.Println ("kansui1 num2 " ,len(str2))  // チE��チE��
...
// ヘッダーをread
          ...
          char2 := str2[j]
//          fmt.Println ("kansui1 char2 " ,char2)  // チE��チE��
          str3 := strings.Split(char2, ":"  )

//          fmt.Println ("kansui1 num3 " ,len(str3))  // チE��チE��
//          fmt.Println("kansui1 str3" ,j ,str3)  // チE��チE��
...
//             fmt.Println("kansui1 Hmax" ,Hmax)  // チE��チE��
...
//             fmt.Println("kansui1 s_coeff" ,s_coeff)  // チE��チE��
...
//             fmt.Println("kansui1 f_coeff" ,f_coeff)  // チE��チE��
          break;

//　流E���E場吁E          case "v" :

             velocity,_ =strconv.ParseFloat(str3[1],64)
//             fmt.Println("kansui1 velocity" ,velocity)  // チE��チE��
...
//             fmt.Println("kansui1 diameter" ,diameter)  // チE��チE��
...
//             fmt.Println("kansui1 length" ,length)  // チE��チE��
...
/// 斁E��を刁E��したので、各種チE�Eタを作�Eする
          ...
          if j == 2 {
             ...
             if tflag == 1 {    // ポイント損失を求めめE
                ...
                fmt.Println("kansui1 hp" ,hp)  // チE��チE��
                ...
                fmt.Println("kansui1 hl" ,hl)  // チE��チE��
...
// チE�Eタがそろった�Eで、書き込み持E��し動水勾配線用チE�Eタを作�Eする
      if wflag == 1 {
         ...
         fmt.Println("kansui1 hp(ad)" ,ad_hp)  // チE��チE��
         ...
         fmt.Println("kansui1 hl(ad)" ,ad_hl)  // チE��チE��

         ad_vhead[index] = strconv.FormatFloat( vhead, 'f' ,8 ,64 )
         fmt.Println("kansui1 vhead(ad)" ,ad_vhead)  // チE��チE��
...
//　 エネルギー線を作�E (up)
         ...
         fmt.Println("kansui1 eneup(ad)" ,ad_eneup)  // チE��チE��
...
//　 エネルギー線を作�E (down)
         ...
         fmt.Println("kansui1 enedown(ad)" ,ad_enedown)  // チE��チE��
...
//　 動水勾配線を作�E (up)
         ...
         fmt.Println("kansui1 glinedown(ad)" ,ad_glineup)  // チE��チE��
...
//　 動水勾配線を作�E (up)
         ...
         fmt.Println("kansui1 glinedown(ad)" ,ad_glinedown)  // チE��チE��
