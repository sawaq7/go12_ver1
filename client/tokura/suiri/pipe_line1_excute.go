...
//    OUT  seven : 導水勾配線（down）のスライス
   ...
   fmt.Println ("func Pipe_line1_excute 水路データ　",wdeta )

// ラインデータを、ブランクで分割する

   str := strings.Fields(wdeta)

   fmt.Println ("Pipe_line1_excute nummax" ,len(str))  // デバック
...
//      fmt.Println("Pipe_line1_excute str2" ,str2)  // デバック
// 水路データをsave

//      fmt.Println ("Pipe_line1_excute num2 " ,len(str2))  // デバック
...
// ヘッダーをread
          ...
          char2 := str2[j]
//          fmt.Println ("Pipe_line1_excute char2 " ,char2)  // デバック
          str3 := strings.Split(char2, ":"  )

//          fmt.Println ("Pipe_line1_excute num3 " ,len(str3))  // デバック
//          fmt.Println("Pipe_line1_excute str3" ,j ,str3)  // デバック
...
//             fmt.Println("Pipe_line1_excute Hmax" ,Hmax)  // デバック
...
//             fmt.Println("Pipe_line1_excute s_coeff" ,s_coeff)  // デバック
...
//             fmt.Println("Pipe_line1_excute f_coeff" ,f_coeff)  // デバック
          break;
...
//             fmt.Println("Pipe_line1_excute velocity" ,velocity)  // デバック
...
//             fmt.Println("Pipe_line1_excute diameter" ,diameter)  // デバック
...
//             fmt.Println("Pipe_line1_excute length" ,length)  // デバック
...
/// 文字を分解したので、各種データを作成する
          ...
          if j == 2 {
             ...
             if tflag == 1 {    // ポイント損失を求める
                ...
                hp = f_coeff * vhead
                fmt.Println("Pipe_line1_excute hp" ,hp)  // デバック
                ...
                fmt.Println("Pipe_line1_excute hl" ,hl)  // デバック
...
// データがそろったので、書き込み指示し動水勾配線用データを作成する
      if wflag == 1 {
         ...
         fmt.Println("Pipe_line1_excute hp(ad)" ,ad_hp)  // デバック
         ...
         fmt.Println("Pipe_line1_excute hl(ad)" ,ad_hl)  // デバック

         ad_vhead[index] = strconv.FormatFloat( vhead, 'f' ,8 ,64 )
         fmt.Println("Pipe_line1_excute vhead(ad)" ,ad_vhead)  // デバック
...
//　 エネルギー線を作成 (up)
         ...
         fmt.Println("Pipe_line1_excute eneup(ad)" ,ad_eneup)  // デバック
...
//　 エネルギー線を作成 (down)
         ...
         fmt.Println("Pipe_line1_excute enedown(ad)" ,ad_enedown)  // デバック
...
//　 動水勾配線を作成 (up)
         ...
         fmt.Println("Pipe_line1_excute glinedown(ad)" ,ad_glineup)  // デバック
...
//　 動水勾配線を作成 (up)
         ...
         fmt.Println("Pipe_line1_excute glinedown(ad)" ,ad_glinedown)  // デバック
